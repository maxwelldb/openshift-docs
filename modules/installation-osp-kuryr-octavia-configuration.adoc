...
. In {rh-openstack} versions 13 and 15, to enforce
...
security groups on the user project. Add the project ID
...
[NOTE]
====
You do not need to perform this task in {rh-openstack} version 16 or later.

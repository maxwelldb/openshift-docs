...
[role="_abstract"]
Configure the control plane machine set to enable automated management, recovery, and configuration updates for control plane machines in your cluster.
...
In {product-title} {product-version}, the control plane machine set is supported for Amazon Web Services (AWS), {gcp-first}, Microsoft Azure, Nutanix, and VMware vSphere clusters.
